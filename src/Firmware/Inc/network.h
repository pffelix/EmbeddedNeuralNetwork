...
#define AI_NETWORK_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 96, 65, 2, 1, NULL), \
}
#define AI_NETWORK_IN_SIZE { \
  (96 * 65 * 2), \
}
#define AI_NETWORK_IN_1_SIZE  (96 * 65 * 2)
#define AI_NETWORK_IN_1_SIZE_BYTES  ((96 * 65 * 2) * 4)
...
#define AI_NETWORK_OUT_1_SIZE  (1 * 1 * 8)
#define AI_NETWORK_OUT_1_SIZE_BYTES  ((1 * 1 * 8) * 4)
